...
export default function IndexPage(props:any) {
  ...
  return (
    ...
    <main className="w-full flex p-4">
      ...
      {showDropDown && 
        <div className='w-60 p-5 rounded-lg bg-white absolute shadow-md' aria-label='city-dropdown'>
...
export const getServerSideProps = storeWrapper.getServerSideProps((store:any)=>async()=>{
