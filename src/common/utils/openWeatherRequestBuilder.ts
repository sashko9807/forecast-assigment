...
export async function openWeatherAddMeasurements(apiKey:string, stationId:string, body:any) {
    const reqBody:any = {
 ...
 const request = await fetch(`https://api.openweathermap.org/data/3.0/measurements?appid=${apiKey}`, reqOptions)
